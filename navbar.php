<!-- Navbar Section -->
<nav class="flex justify-between items-center w-full fixed bg-light p-6">
  <!-- Nav Brand -->
  <a href="index.php" class="text-3xl text-greencstm fill-current font-bold leading-none">
    <svg class="h-10" alt="Nav Brand" viewBox="0 0 10240 10240">
  ...
  <ul class="hidden lg:flex lg:items-center lg:w-auto absolute top-1/2 left-1/2 lg:mx-auto transform -translate-x-1/2 -translate-y-1/2">
    <!-- Dashboard -->
    <li>
      <a href="index.php" class="text-sm text-black hover:text-greencstm font-medium mx-6">Dashboard</a>
    </li>
    <!-- About Us -->
    <li>
      <a href="" class="text-sm text-black hover:text-greencstm font-medium mx-6">About Us</a>
    </li>
    <!-- Services -->
    <li>
      <a href="" class="text-sm text-black hover:text-greencstm font-medium mx-6">Services</a>
    </li>
  </ul>
  <!-- Logout Button -->
  <a href="logout.php" class="hidden lg:inline-block text-sm text-light font-medium bg-red-500 hover:bg-red-700 rounded-md lg:ml-auto lg:mr-4 px-8 py-3">Logout</a>
</nav>
<!-- Navbar Mobile -->
  ...
  <nav class="flex flex-col max-w-sm w-5/6 overflow-y-auto fixed top-0 left-0 bottom-0 bg-light border-r p-6">
    ...
    <div>
      <ul>
        ...
        <!-- About Us -->
        <li class="mb-1">
          <a href="" class="block text-sm text-black font-semibold hover:bg-blue-50 rounded-md px-4 py-3">About Us</a>
        </li>
        <!-- Services -->
        <li class="mb-1">
          <a href="" class="block text-sm text-black font-semibold hover:bg-blue-50 rounded-md px-4 py-3">Services</a>
        </li>
      </ul>
    </div>
    <!-- Logout Button -->
    <div class="mt-auto">
      <div class="pt-6">
        ...
        <!-- Logout Button -->
        <a href="logout.php" class="block text-sm text-light text-center font-semibold bg-red-500 hover:bg-red-700 rounded-md mb-4 lg:mb-0 px-4 py-3">Logout</a>
      </div>
    </div>
  </nav>
</div>